...
const Hero = () => {
  return (
    <section className="h-screen">
      ...
      <div className="absolute top-0 left-0 h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.04] dark:lg:bg-grid-white/[0.02] bg-grid-black/[0.2] flex items-center justify-center">
